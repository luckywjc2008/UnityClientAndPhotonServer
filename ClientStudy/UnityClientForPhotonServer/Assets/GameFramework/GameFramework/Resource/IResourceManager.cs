...
namespace GameFramework.Resource
{
    ...
    public interface IResourceManager
    {
        ...
        /// <param name="userData">用户自定义数据。</param>
        void LoadAssetBundle(string assetBundleName, LoadAssetBundleCallbacks loadAssetBundleCallbacks, object userData);

        /// <summary>
        /// 获取资源包
        /// </summary>
        /// <param name="assetBundleName">要获取的资源包的名称。</param>
        /// <returns></returns>
        object GetAssetBundle(string assetBundleName);
        ...
        void UnloadAssetBundle(string assetBundleName, bool allowDestroyLoadedAssets);
        //!NOWGF

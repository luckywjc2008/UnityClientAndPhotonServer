    ...
    internal partial class ResourceManager
    {
        private partial class ResourceLoader
        {
            private abstract class LoadResourceTaskBase : ITask
            {
                ...
                public LoadResourceTaskBase(string assetName, string assetBundleName, ResourceInfo resourceInfo, string[] dependencyAssetNames, string[] scatteredDependencyAssetNames, string resourceChildName, object userData)
                {
                    m_SerialId = s_Serial++;
                    m_Done = false;

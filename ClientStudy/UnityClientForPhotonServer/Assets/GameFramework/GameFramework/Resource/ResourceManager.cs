...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        public void LoadAssetBundle(string assetBundleName, LoadAssetBundleCallbacks loadAssetBundleCallbacks, object userData)
        {
            ...
            {
                throw new GameFrameworkException("AssetBundle name is invalid.");
            }

            if (loadAssetBundleCallbacks == null)
            {
                throw new GameFrameworkException("Load assetbundle callbacks is invalid.");
            }

            m_ResourceLoader.LoadAssetBundle(assetBundleName, loadAssetBundleCallbacks, userData);
        }
        ...
        public object GetAssetBundle(string assetBundleName)
        {
            ...
            return m_ResourceLoader.GetAssetBundle(assetBundleName);
        }
        ...
        /// <param name="allowDestroyLoadedAssets">是否销毁已加载的资源</param>
        public void UnloadAssetBundle(string assetBundleName, bool allowDestroyLoadedAssets)
        {
            if (string.IsNullOrEmpty(assetBundleName))
            {
                throw new GameFrameworkException("AssetBundleName is invalid.");
            }
            ...
            m_ResourceLoader.UnloadAssetBundle(assetBundleName, allowDestroyLoadedAssets);
        }
        //!NOWGF
        ...
        //NOWGF  通过assetBundleName计算出来的resourceInfo
        private ResourceInfo? GetResourceInfo(string resourceName)
        {
            ResourceInfo resourceInfo = default(ResourceInfo);
            foreach (ResourceName tempResourceName in m_ResourceInfos.Keys)
            {
                if (tempResourceName.Name == resourceName)
                {
                    resourceInfo = m_ResourceInfos[tempResourceName];
                }
            }
            return resourceInfo;
        }

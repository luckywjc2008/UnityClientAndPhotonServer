...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ConfigComponentInspector : GameFrameworkInspector
    {
        ...
        private HelperInfo<ConfigHelperBase> m_ConfigHelperInfo = new HelperInfo<ConfigHelperBase>("ConfigCustom");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.LabelField("ConfigCustom Count", t.ConfigCount.ToString());
            }

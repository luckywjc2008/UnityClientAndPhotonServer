...
namespace StarForce
{
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        protected internal override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            // 画质配置：根据检测到的硬件信息 Assets/Main/Configs/DeviceModelConfigObject 和用户配置数据，设置即将使用的画质选项。
            InitQualitySettings();
        ...
        {
            QualityLevelType defaultQuality = GameEntry.BuiltinData.DeviceModelConfigObject.GetDefaultQualityLevel();

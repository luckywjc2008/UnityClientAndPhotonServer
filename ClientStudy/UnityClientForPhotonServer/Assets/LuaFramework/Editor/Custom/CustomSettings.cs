...
public static class CustomSettings
{
    ...
    {        
        ...
        _DT(typeof(GameFramework.Resource.LoadAssetSuccessCallback)),
        _DT(typeof(GameFramework.Resource.LoadAssetFailureCallback)),
        _DT(typeof(GameFramework.Resource.LoadAssetUpdateCallback)),
        _DT(typeof(GameFramework.Resource.LoadAssetDependencyAssetCallback)),
    ...
    {                
        ...
        _GT(typeof(GameFramework.GameFrameworkEntry)),
        _GT(typeof(GameFramework.Resource.LoadAssetCallbacks)),
        _GT(typeof(GameFramework.Resource.LoadResourceStatus)),
        _GT(typeof(GameFramework.Utility.Converter)),
        _GT(typeof(GameFramework.Log)),
        #endregion
        ...
        _GT(typeof(UnityGameFramework.Runtime.Constant.DevicePlatform)),
        _GT(typeof(UnityGameFramework.Runtime.Constant.DevicePlatform.DevicePlamformEnum)),
        ...
        _GT(typeof(UnityGameFramework.Runtime.Lua.LuaComponent)),
        _GT(typeof(UnityGameFramework.Runtime.BaseComponent)),
        _GT(typeof(UnityGameFramework.Runtime.ShutdownType)),
        _GT(typeof(UnityGameFramework.Runtime.ListLoader)),
        _GT(typeof(UnityGameFramework.Runtime.ClipboardUtility)),
        #endregion

        #region StarForce
        _GT(typeof(StarForce.ByteBuffer)),
        _GT(typeof(StarForce.GameEntry)),
        _GT(typeof(StarForce.AssetUtility)),
        _GT(typeof(StarForce.SoundExtension)),
        _GT(typeof(StarForce.BuildInfo)),
        _GT(typeof(XMLParser)),
        _GT(typeof(XMLNode)),
        _GT(typeof(XMLNodeList)),
        _GT(typeof(Task)),

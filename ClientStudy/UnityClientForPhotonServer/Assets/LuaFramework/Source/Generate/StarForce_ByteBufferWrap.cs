...
public class StarForce_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(StarForce.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateStarForce_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateStarForce_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				StarForce.ByteBuffer obj = new StarForce.ByteBuffer();
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(byte[])))
			{
				...
				StarForce.ByteBuffer obj = new StarForce.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: StarForce.ByteBuffer.New");
			}
		}
		catch(Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			StarForce.ByteBuffer obj = (StarForce.ByteBuffer)ToLua.CheckObject(L, 1, typeof(StarForce.ByteBuffer));
			obj.Close();
			return 0;
		}
		catch(Exception e)
